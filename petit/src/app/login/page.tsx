...
const Login = () => {
  return <div className="overflow-y-auto h-full bg-white">
    <div className="h-[55vh] "><BannerCarousel /></div>
    <div className="h-[45vh] p-12">
        ...
        <div className="w-full mt-[4vh] pb-[10vh]">
            ...
            <button className="border border-black w-full h-[7vh] rounded-lg items-center flex justify-center mb-[2vh]">
